...
plot(hpc2$dateTime, hpc2$Voltage, type = "n", ylab = "Global Active Power (kilowatts)", xlab = "datetime")
...
plot(hpc2$dateTime, hpc2$Global_reactive_power, type = "n", ylab = "Global Active Power (kilowatts)", xlab = "datetime")
...
## note -- need to change to have graphs appear properly when done 2x2 -- too squished when copying and legend too big
